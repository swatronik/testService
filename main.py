...
from routers import person, token
...
if __name__ == '__main__':
    ...
    def create_app() -> FastAPI:
        ...
        current_app.include_router(person.router, prefix="/api/person", tags=["person"])
        current_app.include_router(token.router, prefix="/api/users", tags=["users"])
        return current_app
